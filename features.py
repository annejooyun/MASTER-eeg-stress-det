...
def time_series_features(data):
    ...
    The data should be on the form (n_trials, n_secs, v.NUM_CHANNELS, v.SFREQ)
    The output is on the form (n_trials*n_secs, v.NUM_CHANNELS*3)
    '''
...
def fractal_features(data):
    ...
    The data should be on the form (n_trials, n_secs, v.NUM_CHANNELS, v.SFREQ)
    The output is on the form (n_trials*n_secs, v.NUM_CHANNELS*2)
    '''
...
def entropy_features(data):
    ...
    The data should be on the form (n_trials, n_secs, v.NUM_CHANNELS, v.SFREQ)
    The output is on the form (n_trials*n_secs, v.NUM_CHANNELS*4)
    '''
...
def freq_band_features(data, freq_bands):
    ...
    The data should be on the form (n_trials, n_secs, v.NUM_CHANNELS, v.SFREQ)
    The output is on the form (n_trials*n_secs, v.NUM_CHANNELS*5)
    '''
